...
At the end of my last post, I discussed wanting to visualize wordclouds that represent both corpora in one plot, as an easier way to really compare and contrast the themes of each. I've included two of those here. One contains the entire lyric and newspaper dfm, and the other contains smaller dfms from the key word "peace". 
