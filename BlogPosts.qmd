...
In order to uncover patterns in my data, I experimented with a variety of methods. Working with song lyrics has been challenging, but I've continued my work with sentiment analysis, and began to perform topic modeling. I'm also exploring keywords in context (kwic) to get a better understanding. For my OCR work with ProQuest, I am still struggling with data wrangling. I've had to manually download PDFs, which is time consuming and I'm working on a better solution. Despite these challenges, I'm starting to see my data more clearly and uncover themes. 
...
I wanted to see how the lyrics relate to these topics that were pertinent to the counterculture movement. I created a couple wordclouds with these key words. 
...
I looked at sentiment scores for the "free" key word, and found the polarity to be overwhelmingly positive. The distribution here is much less evenly spread than in the overall corpus. 
...
I used topic modeling techniques to try to understand topics in my corpus. This has proved challenging with song lyrics, and I needed to get creative with my stopwords. 
...
There seems to be prevalance with themes like "love", "share", "home", "time". I've found that I need to continually tweak my code to account for words in songs that aren't really words, and this has made it more difficult to uncover overall themes that are often represented in abstract ways. Because of this, it's helpful to incorporate analysis on historical newspapers from the time of the counterculture movement to see how mainstream media is looking at topics such as the Vietnam war.  
